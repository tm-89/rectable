...
def get_act(config):
  ...
  if config.model_activation.lower() == 'elu':
    return nn.ELU()
  elif config.model_activation.lower() == 'relu':
    return nn.ReLU()
  elif config.model_activation.lower() == 'lrelu':
    return nn.LeakyReLU(negative_slope=0.2)
  elif config.model_activation.lower() == 'swish':
    return nn.SiLU()
  else:
